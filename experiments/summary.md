...
- Run: `20260421T151827.907314Z-4b6c733-metal`
- Time: `2026-04-21T15:18:27.907314+00:00`
- Commit: `4b6c733` on `codex/zig-baseline-qwen36`
- Dirty tree: `False`
- Subject: r007: add metal qkv projection kernel
- Label: r007
- Notes: add metal qkv projection kernel

## Latest Metrics

| Suite | Metric | Value | Delta vs previous same suite |
|---|---|---:|---:|
| Metal Add-One | `metal_elements_per_s` | 2342401429.69 elements/s | -2300396887.78 |
| Metal QKV Projection | `metal_projection_passes_per_s` | 1282.30 projection/s | n/a |
...
| Metal QKV Projection | 1282.30 projection/s | `4b6c733` | `2026-04-21T15:18:27.907314+00:00` | r007 |
